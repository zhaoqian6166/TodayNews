 ...
 */
public class Video_tuijian extends Fragment {
    ...
    private void initView() {
         ...
         */
        path = "http://c.3g.163.com/nc/video/list/V9LG4B3A0/n/"+start+"-"+end+".html";
            ...
            public void onRefresh() {
                ...
                listView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.i("下拉",path);
                       // String path_new=" http://c.3g.163.com/nc/video/list/V9LG4CHOR/n/10-10.html";
                        ArrayList<VideoBean> list = VideoGetDataUtil.getList();
